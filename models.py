...
class Admin(User):
    ...
    def get_todo_stats(self):
        return {todo.user.username: Todo.query.filter_by(user_id=todo.user_id).count() for todo in Todo.query.all()}
